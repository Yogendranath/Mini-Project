<?php
include 'navbar_explore_menu.php';
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" href="Explore Menu.css">
</head>
<body>
    <div class="explore-menu-section pt-5 pb-3">
        <div class="container">
            <h1 class="menu-section-heading mb-3">Explore Menu</h1>
            <div class="row">
