...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" href="Whychoose Us.css">
</head>
 
  <body>
    <div class="wcu-section pt-5 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="wcu-heading">Why Choose Us ?</h1>
                    <p class="wcu-section-description">We use both original recipes and classic versions of famous food
                        items.</p>
                </div>
                <div class="col-12 col-md-4">
                    <div class="wcu-card pt-3 mb-3">
                        ...
                        <p class="wcu-card-description">Experience fine dining at the comfort of your home. All our orders are carefully packed and arranged to give you the nothing less than perfect.</p>                        
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="wcu-card pt-3 mb-3">
                ...
                <div class="col-12 col-md-4">
                    <div class="wcu-card pt-3 mb-3">
                        ...
                        <p class="wcu-card-description">Food Coupons & Offers upto
