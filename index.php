  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
      <div class="container">
        ...
        <div class="collapse navbar-collapse bg-primary" id="navbarNavAltMarkup">
            ...
            <a class="nav-link" id="navItem4"href="Login.php">Login/SignUp</a>
            </div>
        </div>
        </div>
    </nav>
    <div class="banner-section-bg-container d-flex flex-column justify-content-center">
        <div class="text-center">
            <h1 class="banner-heading mb-3">Get Delicious Food Any Time</h1>
            <p class="banner-para mb-4">Eat smart & Healthy</p>
